# ============================================================================
# wesad_reanalyses.py
# WESAD post-processing from the saved model fit: participant-clustered bootstrap
# AUC CIs, per-participant class counts, threshold-choice sensitivity, Model-D
# calibration for the exceedance event, and the full 77-feature list.
# ============================================================================
